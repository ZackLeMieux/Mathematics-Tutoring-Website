...
export default class Floor{
    ...
    setCircles() {
        ...
        const material1 = new THREE.MeshStandardMaterial({color: 0x1973b2});
        ...
        this.circleFirst.position.x = 0.85;
        this.circleFirst.position.y = -0.29;
        this.circleFirst.position.z = -0.95;

        this.circleSecond.position.x = 1.75;
        this.circleSecond.position.y = -0.28;
        this.circleSecond.position.z = -1.15;

        this.circleThird.position.x = -0.27;
        this.circleThird.position.y = -0.27;
        this.circleThird.position.z = -3;
